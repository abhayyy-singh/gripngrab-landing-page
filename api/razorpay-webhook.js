...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
  ...
  <tr><td style="padding:20px 40px;background:#f8f9fc;border-top:1px solid #e5e7eb;">
    <table width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr><td style="color:#6b7280;font-size:13px;font-weight:600;padding:8px 0;border-top:1px solid #e5e7eb;">Date &amp; Time</td><td style="color:#1f2937;text-align:right;font-weight:700;border-top:1px solid #e5e7eb;">${getNextSundayDate()} · 9:00 AM</td></tr>
