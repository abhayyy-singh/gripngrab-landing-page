/* ============================================================================
   ...
   Vercel Serverless Function — Notify Me admin email
   ----------------------------------------------------------------------------
   Called by notify-leads.js after a lead is saved to Firestore.
   Sends a notification email to the admin.

   ENV VARS (Vercel dashboard):
     RESEND_API_KEY   → Resend API key
     NOTIFY_EMAIL     → Admin email for notifications (haristhenics06@gmail.com)
   ============================================================================ */
